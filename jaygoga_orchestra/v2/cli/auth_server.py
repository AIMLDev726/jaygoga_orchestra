...
class CliAuthRequestHandler(BaseHTTPRequestHandler):
    ...
    TODO:
        * Fix the header and limit to only localhost or jaygoga_orchestra.v2.com
    """
    ...
    def _redirect_with_status(self, theme: str, redirect_uri, result: str, error_type: str = ""):
        ...
        if theme == "dark":
            ...
            loader_color = "#FAFAFA"
            auth_svg_link = "https://jaygoga_orchestra.v2-public.s3.us-east-1.amazonaws.com/assets/Auth-darkmode.svg"
        else:
            background_color = "#FFFFFF"
            text_color_large = "#18181B"
            text_color_small = "rgba(113, 113, 122, 1)"
            loader_color = "#18181B"
            auth_svg_link = "https://jaygoga_orchestra.v2-public.s3.us-east-1.amazonaws.com/assets/Auth-lightmode.svg"

        html = f"""
        <html>
        <head>
            <title>Govinda Workspace</title>
