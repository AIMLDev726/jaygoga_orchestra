...
from jaygoga_orchestra.v2.api.playground import PlaygroundEndpointCreate
from jaygoga_orchestra.v2.app.playground.async_router import get_async_playground_router
...
class Playground:
    ...
    def register_app_on_platform(self) -> None:
        ...
        from jaygoga_orchestra.v2.api.app import AppCreate, create_app
