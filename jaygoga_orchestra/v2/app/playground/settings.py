...
class PlaygroundSettings(BaseSettings):
    ...
    env: str = "dev"
    title: str = "jaygoga_orchestra.v2-playground"
    ...
    def set_cors_origin_list(cls, cors_origin_list):
        ...
        # Add Govinda domains to cors origin list
        valid_cors.extend(
            [
                "http://localhost:3000",
                "https://jaygoga_orchestra.v2.com",
                "https://www.jaygoga_orchestra.v2.com",
                "https://app.jaygoga_orchestra.v2.com",
                "https://app-stg.jaygoga_orchestra.v2.com",
            ]
        )
