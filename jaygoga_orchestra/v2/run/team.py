...
from jaygoga_orchestra.v2.media import AudioArtifact, AudioResponse, ImageArtifact, VideoArtifact
from jaygoga_orchestra.v2.models.message import Citations, Message
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "TeamRunResponse":
        ...
        for event in events or []:
            if "agent_id" in event:
                ...
                from jaygoga_orchestra.v2.run.response import run_response_event_from_dict
