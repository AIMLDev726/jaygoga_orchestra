...
from jaygoga_orchestra.v2.media import AudioArtifact, ImageArtifact, VideoArtifact
from jaygoga_orchestra.v2.memory.v2.db.base import MemoryDb
from jaygoga_orchestra.v2.memory.v2.db.schema import MemoryRow
from jaygoga_orchestra.v2.memory.v2.manager import MemoryManager
from jaygoga_orchestra.v2.memory.v2.schema import SessionSummary, UserMemory
from jaygoga_orchestra.v2.memory.v2.summarizer import SessionSummarizer
    ...
    def get_model(self) -> Model:
        if self.model is None:
            try:
                ...
                logger.exception(e)
                logger.error(
                    "Govinda uses `openai` as the default model provider. Please provide a `model` or install `openai`."
                )
                exit(1)
