...
class WorkspaceSettings(BaseSettings):
    ...
    # default env for jaygoga_orchestra.v2 ws commands
    default_env: Optional[str] = "dev"
    # default infra for jaygoga_orchestra.v2 ws commands
    default_infra: Optional[str] = None

    # Image Settings
    # Repository for images
    image_repo: str = "jaygoga_orchestra.v2hq"
    ...
    # ag cli settings
    # Set to True if Govinda should continue creating
    # resources after a resource creation has failed
    continue_on_create_failure: bool = False
    # Set to True if Govinda should continue deleting
    ...
    # Set to True if Govinda should continue patching
