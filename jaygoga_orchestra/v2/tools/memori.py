...
class MemoriTools(Toolkit):
    ...
    This toolkit integrates Memori's memory system with Govinda, allowing Agents and Teams to:
    ...
    Example:
        ```python
        from jaygoga_orchestra.v2.tools.memori import MemoriTools
...
def create_memori_search_tool(memori_toolkit: MemoriTools):
    """
    Create a standalone memory search function for use with Govinda agents.
