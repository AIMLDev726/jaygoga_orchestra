...
from jaygoga_orchestra.v2.utils.log import log_debug, log_info, log_warning, logger
from jaygoga_orchestra.v2.utils.mcp import get_entrypoint_for_tool
...
class MCPTools(Toolkit):
    """
    A toolkit for integrating Model Context Protocol (MCP) servers with Govinda agents.
...
class MultiMCPTools(Toolkit):
    """
    A toolkit for integrating multiple Model Context Protocol (MCP) servers with Govinda agents.
    This allows agents to access tools, resources, and prompts exposed by MCP servers.
