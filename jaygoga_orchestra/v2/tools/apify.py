...
class ApifyTools(Toolkit):
    def __init__(self, actors: Optional[Union[str, List[str]]] = None, apify_api_token: Optional[str] = None):
        ...
        Examples:
            ...
            pip install jaygoga_orchestra.v2 apify-client
            ...
            from jaygoga_orchestra.v2.tools.apify import ApifyTools
            ...
            agent.print_response("Summarize the content from https://docs.jaygoga_orchestra.v2.com/introduction", markdown=True)
