...
try:
    from jaygoga_orchestra.v2.aws.resource.s3.object import S3Object  # type: ignore
except (ModuleNotFoundError, ImportError):
    raise ImportError("`jaygoga_orchestra.v2-aws` not installed. Please install using `pip install jaygoga_orchestra.v2-aws`")
