...
from jaygoga_orchestra.v2.exceptions import ModelProviderError, StopAgentRun
...
from jaygoga_orchestra.v2.memory.agent import AgentMemory, AgentRun
...
from jaygoga_orchestra.v2.models.message import Citations, Message, MessageMetrics, MessageReferences
...
from jaygoga_orchestra.v2.utils.prompts import get_json_output_prompt, get_response_model_format_prompt
...
class Agent:
    ...
    def _run_stream(
        ...
        if self.output_model is None:
            ...
            from jaygoga_orchestra.v2.run.response import IntermediateRunResponseContentEvent, RunResponseContentEvent
            ...
            if isinstance(self.memory, AgentMemory):
                try:
                    ...
                    if "memories" in session.memory:
                        from jaygoga_orchestra.v2.memory.memory import Memory as AgentUserMemory
