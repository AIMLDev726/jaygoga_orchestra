...
from jaygoga_orchestra.v2.agent.metrics import SessionMetrics
from jaygoga_orchestra.v2.exceptions import ModelProviderError, RunCancelledException
from jaygoga_orchestra.v2.knowledge.agent import AgentKnowledge
from jaygoga_orchestra.v2.media import Audio, AudioArtifact, AudioResponse, File, Image, ImageArtifact, Video, VideoArtifact
from jaygoga_orchestra.v2.memory.agent import AgentMemory
from jaygoga_orchestra.v2.memory.team import TeamMemory, TeamRun
from jaygoga_orchestra.v2.memory.v2.memory import Memory, SessionSummary
...
from jaygoga_orchestra.v2.reasoning.step import NextAction, ReasoningStep, ReasoningSteps
from jaygoga_orchestra.v2.run.base import RunResponseExtraData, RunStatus
from jaygoga_orchestra.v2.run.messages import RunMessages
from jaygoga_orchestra.v2.run.response import RunEvent, RunResponse, RunResponseEvent
from jaygoga_orchestra.v2.run.team import TeamRunEvent, TeamRunResponse, TeamRunResponseEvent, ToolCallCompletedEvent
...
from jaygoga_orchestra.v2.utils.events import (
...
from jaygoga_orchestra.v2.utils.message import get_text_from_message
from jaygoga_orchestra.v2.utils.response import (
...
class Team:
    ...
    def _set_default_model(self) -> None:
        ...
        if self.model is None:
            try:
                ...
                log_exception(e)
                log_error(
                    "Govinda agents use `openai` as the default model provider. "
    ...
    def _run_stream(
        ...
        if self.output_model is None:
            ...
            for event in self._handle_model_response_stream(
                ...
                from jaygoga_orchestra.v2.run.team import IntermediateRunResponseContentEvent, RunResponseContentEvent
    ...
    def _print_response(
        ...
        **kwargs: Any,
        ...
        from jaygoga_orchestra.v2.utils.response import format_tool_calls
    ...
    def _reason(
        ...
        if reasoning_model_provided:
            from jaygoga_orchestra.v2.reasoning.azure_ai_foundry import is_ai_foundry_reasoning_model
            from jaygoga_orchestra.v2.reasoning.deepseek import is_deepseek_reasoning_model
            from jaygoga_orchestra.v2.reasoning.groq import is_groq_reasoning_model
            from jaygoga_orchestra.v2.reasoning.helpers import get_reasoning_agent
            from jaygoga_orchestra.v2.reasoning.ollama import is_ollama_reasoning_model
            from jaygoga_orchestra.v2.reasoning.openai import is_openai_reasoning_model
            ...
            if is_deepseek or is_groq or is_openai or is_ollama or is_ai_foundry:
                ...
                if is_deepseek:
                    from jaygoga_orchestra.v2.reasoning.deepseek import get_deepseek_reasoning
                    ...
                    from jaygoga_orchestra.v2.reasoning.groq import get_groq_reasoning
                    ...
                    from jaygoga_orchestra.v2.reasoning.openai import get_openai_reasoning
                    ...
                    from jaygoga_orchestra.v2.reasoning.ollama import get_ollama_reasoning
                    ...
                    from jaygoga_orchestra.v2.reasoning.azure_ai_foundry import get_ai_foundry_reasoning
        ...
        if use_default_reasoning:
            from jaygoga_orchestra.v2.reasoning.default import get_default_reasoning_agent
            from jaygoga_orchestra.v2.reasoning.helpers import get_next_action, update_messages_with_reasoning
    ...
    async def _areason(
        ...
        if reasoning_model_provided:
            ...
            if is_deepseek or is_groq or is_openai or is_ollama or is_ai_foundry:
                reasoning_message: Optional[Message] = None
                if is_deepseek:
                    from jaygoga_orchestra.v2.reasoning.deepseek import aget_deepseek_reasoning
                    ...
                    from jaygoga_orchestra.v2.reasoning.groq import aget_groq_reasoning
                    ...
                    from jaygoga_orchestra.v2.reasoning.openai import aget_openai_reasoning
    ...
    def get_system_message(
        ...
        if self.add_location_to_instructions:
            from jaygoga_orchestra.v2.utils.location import get_location
            ...
            if isinstance(self.memory, TeamMemory):
                try:
                    ...
                    if "memories" in session.memory:
                        from jaygoga_orchestra.v2.memory.memory import Memory as UserMemoryV1
                ...
                if "team_context" in session.memory:
                    from jaygoga_orchestra.v2.memory.v2.memory import TeamContext
                ...
                if "memories" in session.memory:
                    if self.memory.memories is not None:
                        ...
                        from jaygoga_orchestra.v2.memory.v2.memory import UserMemory as UserMemoryV2
                ...
                if "summaries" in session.memory:
                    if self.memory.summaries is not None:
                        ...
                        from jaygoga_orchestra.v2.memory.v2.memory import SessionSummary as SessionSummaryV2
    ...
    def _add_reasoning_step_to_extra_data(self, run_response: TeamRunResponse, reasoning_step: ReasoningStep) -> None:
        if run_response.extra_data is None:
            from jaygoga_orchestra.v2.run.response import RunResponseExtraData
