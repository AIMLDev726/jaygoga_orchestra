...
This module provides configuration for Govinda security features, including:
- Authentication settings
- Scoping rules
- Fingerprinting

The SecurityConfig class is the primary interface for managing security settings
in Govinda applications.
"""
...
class SecurityConfig(BaseModel):
    ...
    This class manages security settings for Govinda agents, including:
