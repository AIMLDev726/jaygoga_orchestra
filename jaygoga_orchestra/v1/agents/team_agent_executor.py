...
from jaygoga_orchestra.v1.agents.agent_builder.base_agent_executor_mixin import CrewAgentExecutorMixin
from jaygoga_orchestra.v1.agents.parser import (
    AgentAction,
    AgentFinish,
...
from jaygoga_orchestra.v1.tools.tool_types import ToolResult
from jaygoga_orchestra.v1.utilities import I18N, Printer
...
from jaygoga_orchestra.v1.utilities.constants import MAX_LLM_RETRY, TRAINING_DATA_FILE
...
class CrewAgentExecutor(CrewAgentExecutorMixin):
    ...
    def _show_start_logs(self):
        ...
        event_bus.emit(
            ...
            AgentLogsStartedEvent(
                ...
                or (hasattr(self, "squad") and getattr(self.squad, "verbose", False)),
            ),
        )
    ...
    def _handle_crew_training_output(
        ...
        train_iteration = (
            getattr(self.squad, "_train_iteration", None) if self.squad else None
        )
    ...
    def _is_training_mode(self) -> bool:
        """Check if squad is in training mode."""
        return bool(self.squad and self.squad._train)
