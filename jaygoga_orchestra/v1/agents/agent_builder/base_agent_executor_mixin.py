...
from jaygoga_orchestra.v1.utilities.converter import ConverterError
...
from jaygoga_orchestra.v1.utilities.events.event_listener import event_listener
...
class CrewAgentExecutorMixin:
    ...
    def _create_external_memory(self, output) -> None:
        ...
        if (
            ...
            and self.agent
            and self.task
            and hasattr(self.squad, "_external_memory")
            and self.squad._external_memory
        ):
            try:
                self.squad._external_memory.save(
                    value=output.text,
                    metadata={
    ...
    def _ask_human_input(self, final_answer: str) -> str:
        ...
        try:
            ...
            if self.squad and getattr(self.squad, "_train", False):
                prompt = (
                    "\n\n=====\n"
