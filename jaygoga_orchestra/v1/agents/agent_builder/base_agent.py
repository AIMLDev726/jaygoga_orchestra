...
from jaygoga_orchestra.v1.knowledge.knowledge_config import KnowledgeConfig
...
from jaygoga_orchestra.v1.utilities import I18N, Logger, RPMController
...
class BaseAgent(ABC, BaseModel):
    ...
    Methods:
        ...
        get_delegation_tools(agents: List["BaseAgent"]):
            Abstract method to set the agents task tools for handling delegation and question asking to other agents in squad.
