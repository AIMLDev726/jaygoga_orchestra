...
from jaygoga_orchestra.v1.flow.config import COLORS, NODE_STYLES
from jaygoga_orchestra.v1.flow.html_template_handler import HTMLTemplateHandler
from jaygoga_orchestra.v1.flow.legend_generator import generate_legend_items_html, get_legend_items
from jaygoga_orchestra.v1.flow.path_utils import safe_path_join, validate_path_exists
from jaygoga_orchestra.v1.flow.utils import calculate_node_levels
from jaygoga_orchestra.v1.flow.visualization_utils import (
    add_edges,
...
class FlowPlot:
    ...
    def _generate_final_html(self, network_html):
        ...
        try:
            ...
            template_path = safe_path_join("assets", "jaygoga_orchestra.v1_flow_visual_template.html", root=current_dir)
            logo_path = safe_path_join("assets", "jaygoga_orchestra.v1_logo.svg", root=current_dir)
