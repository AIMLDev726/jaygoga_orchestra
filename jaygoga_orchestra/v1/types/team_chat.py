...
class ChatInputs(BaseModel):
    ...
    Example:
        {
            ...
            "crew_description": "Use this squad for topic-based Q&A",
            "inputs": [
    ...
    crew_name: str = Field(..., description="The name of the squad")
    crew_description: str = Field(
        ..., description="A description of the squad's purpose"
    )
    inputs: List[ChatInputField] = Field(
        default_factory=list, description="A list of input fields for the squad"
    )