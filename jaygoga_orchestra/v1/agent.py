...
from jaygoga_orchestra.v1.agents import CacheHandler
from jaygoga_orchestra.v1.agents.agent_builder.base_agent import BaseAgent
from jaygoga_orchestra.v1.agents.team_agent_executor import CrewAgentExecutor
...
from jaygoga_orchestra.v1.knowledge.utils.knowledge_utils import extract_knowledge_context
from jaygoga_orchestra.v1.lite_agent import LiteAgent, LiteAgentOutput
from jaygoga_orchestra.v1.llm import BaseLLM
from jaygoga_orchestra.v1.memory.contextual.contextual_memory import ContextualMemory
from jaygoga_orchestra.v1.security import Fingerprint
...
from jaygoga_orchestra.v1.utilities import Converter, Prompts
from jaygoga_orchestra.v1.utilities.agent_utils import (
    get_tool_names,
    load_agent_from_repository,
    parse_tools,
    render_text_description_and_args,
)
from jaygoga_orchestra.v1.utilities.constants import TRAINED_AGENTS_DATA_FILE, TRAINING_DATA_FILE
...
from jaygoga_orchestra.v1.utilities.events.knowledge_events import (
...
class Agent(BaseAgent):
    ...
    crew_knowledge_context: Optional[str] = Field(
        default=None,
        description="Knowledge context for the squad.",
    )
    ...
    def _is_any_available_memory(self) -> bool:
        ...
        return any(getattr(self.squad, attr) for attr in memory_attributes)
    ...
    def execute_task(
        ...
        if self.reasoning:
            try:
                from jaygoga_orchestra.v1.utilities.reasoning_handler import (
                    AgentReasoning,
        ...
        if self.knowledge or (self.squad and self.squad.knowledge):
            ...
            try:
                ...
                if self.knowledge_search_query:
                    ...
                    # Quering squad specific knowledge
                    knowledge_snippets = self.squad.query_knowledge(
                        [self.knowledge_search_query], **knowledge_config
                    )
    ...
    def get_multimodal_tools(self) -> Sequence[BaseTool]:
        from jaygoga_orchestra.v1.tools.agent_tools.add_image_tool import AddImageTool

        return [AddImageTool()]

    def get_code_execution_tools(self):
        try:
            from jaygoga_orchestra.v1_tools import CodeInterpreterTool  # type: ignore
            ...
            self._logger.log(
                "info", "Coding tools not available. Install jaygoga_orchestra.v1_tools. "
            )
    ...
    def execute(
        ...
        return lite_agent.execute(messages)
    ...
    async def kickoff_async(
        ...
        This is the async version of the execute method.
