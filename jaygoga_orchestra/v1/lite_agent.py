...
from jaygoga_orchestra.v1.utilities.guardrail import process_guardrail
...
class LiteAgent(FlowTrackable, BaseModel):
    ...
    where a full squad is not needed.
    ...
    def execute(self, messages: Union[str, List[Dict[str, str]]]) -> LiteAgentOutput:
        """
    ...
    async def kickoff_async(
        ...
        Returns:
            LiteAgentOutput: The result of the agent execution.
        """
        return await asyncio.to_thread(self.execute, messages)
