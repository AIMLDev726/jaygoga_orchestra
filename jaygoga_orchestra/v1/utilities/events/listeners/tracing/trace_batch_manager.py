...
from jaygoga_orchestra.v1.utilities.events.listeners.tracing.types import TraceEvent
    ...
    def _initialize_backend_batch(
        ...
        try:
            payload = {
                ...
                "execution_type": execution_metadata.get("execution_type", "squad"),
                ...
                "execution_context": {
                    ...
                    "jaygoga_orchestra.v1_version": self.current_batch.version,
    ...
    def _finalize_backend_batch(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                console = Console()
                return_link = (
                    f"{CREWAI_BASE_URL}/jaygoga_orchestra.v1_plus/trace_batches/{self.trace_batch_id}"
                    if not self.is_current_batch_ephemeral and access_code is None
                    else f"{CREWAI_BASE_URL}/jaygoga_orchestra.v1_plus/ephemeral_trace_batches/{self.trace_batch_id}?access_code={access_code}"
                )
                panel = Panel(
