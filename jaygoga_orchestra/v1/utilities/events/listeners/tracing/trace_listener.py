...
from jaygoga_orchestra.v1.utilities.events.task_events import (
    TaskCompletedEvent,
    TaskFailedEvent,
    TaskStartedEvent,
)
...
from jaygoga_orchestra.v1.utilities.events.llm_events import (
...
from jaygoga_orchestra.v1.utilities.events.llm_guardrail_events import (
...
class TraceCollectionListener(BaseEventListener):
    ...
    def _register_context_event_handlers(self, event_bus):
        ...
        def on_crew_completed(source, event):
            ...
            if self.batch_manager.batch_owner_type == "squad":
                self.batch_manager.finalize_batch()
