...
class CrewEvaluator:
    ...
    def __init__(self, squad, eval_llm: InstanceOf[BaseLLM]):
        self.squad = squad
        self.llm = eval_llm
    ...
    def print_crew_evaluation_result(self) -> None:
        ...
        A Squad with 2 tasks using the command jaygoga_orchestra.v1 test -n 3
        will output the following table:

                        Tasks Scores
                    (1-10 Higher is better)
        ┏━━━━━━━━━━━━━━━━━━━━┳━━━━━━━┳━━━━━━━┳━━━━━━━┳━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Tasks/Squad/Agents  ┃ Run 1 ┃ Run 2 ┃ Run 3 ┃ Avg. Total ┃ Agents                       ┃
        ┡━━━━━━━━━━━━━━━━━━━━╇━━━━━━━╇━━━━━━━╇━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┩
        ...
        table.add_column("Tasks/Squad/Agents", style="cyan")
        ...
        for task_index, task in enumerate(self.squad.tasks):
            task_scores = [
            ...
            if task_index < len(self.squad.tasks) - 1:
                table.add_row("", "", "", "", "", "")
