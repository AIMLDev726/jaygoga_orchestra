...
from jaygoga_orchestra.v1.agents.agent_builder.utilities.base_output_converter import OutputConverter
...
class Converter(OutputConverter):
    ...
    def _create_instructor(self):
        ...
        from jaygoga_orchestra.v1.utilities import InternalInstructor
    ...
    def _convert_with_instructions(self):
        """Create a chain."""
        from jaygoga_orchestra.v1.utilities.crew_pydantic_output_parser import (
