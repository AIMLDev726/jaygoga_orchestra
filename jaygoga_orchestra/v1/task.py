...
from jaygoga_orchestra.v1.utilities.config import process_config
from jaygoga_orchestra.v1.utilities.constants import NOT_SPECIFIED, _NotSpecified
from jaygoga_orchestra.v1.utilities.guardrail import process_guardrail, GuardrailResult
from jaygoga_orchestra.v1.utilities.converter import Converter, convert_to_model
from jaygoga_orchestra.v1.utilities.events import (
    TaskCompletedEvent,
    TaskFailedEvent,
    TaskStartedEvent,
)
...
class Task(BaseModel):
    ...
    def handle_max_retries_deprecation(self):
        if self.max_retries is not None:
            warnings.warn(
                "The 'max_retries' parameter is deprecated and will be removed in Govinda v1.0.0. "
    ...
    def _execute_core(
        ...
        try:
            ...
            squad = self.agent.squad  # type: ignore[union-attr]
            if squad and squad.task_callback and squad.task_callback != self.callback:
                squad.task_callback(self.output)
...
- Use ```language for code blocks"""
    ...
    def _save_file(self, result: Union[Dict, str, Any]) -> None:
        ...
        Note:
            ...
            from the jaygoga_orchestra.v1_tools package:
                pip install 'jaygoga_orchestra.v1[tools]'
                from jaygoga_orchestra.v1_tools import FileWriterTool
        ...
        Raises:
            ...
            RuntimeError: If there is an error writing to the file. For cross-platform
                compatibility, especially on Windows, use FileWriterTool from jaygoga_orchestra.v1_tools
                package.
        """
        ...
        FILEWRITER_RECOMMENDATION = (
            ...
            "use FileWriterTool from jaygoga_orchestra.v1_tools package."
        )
