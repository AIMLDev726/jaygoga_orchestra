...
class PlusAPI:
    """
    This class exposes methods for working with the Govinda+ API.
    """

    TOOLS_RESOURCE = "/jaygoga_orchestra.v1_plus/api/v1/tools"
    ORGANIZATIONS_RESOURCE = "/jaygoga_orchestra.v1_plus/api/v1/me/organizations"
    CREWS_RESOURCE = "/jaygoga_orchestra.v1_plus/api/v1/crews"
    AGENTS_RESOURCE = "/jaygoga_orchestra.v1_plus/api/v1/agents"
    TRACING_RESOURCE = "/jaygoga_orchestra.v1_plus/api/v1/tracing"
    EPHEMERAL_TRACING_RESOURCE = "/jaygoga_orchestra.v1_plus/api/v1/tracing/ephemeral"
