...
from jaygoga_orchestra.v1.cli.constants import (
...
DEFAULT_CONFIG_PATH = Path.home() / ".config" / "govinda" / "settings.json"
...
class Settings(BaseModel):
    enterprise_base_url: Optional[str] = Field(
        ...
        description="Base URL of the Govinda Enterprise instance",
    )
